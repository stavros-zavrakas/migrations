...
$config['db']['mongodb']['database'] 	= 'boxDB';
...
$config['db']['postgres']['database'] = 'styloolaDB';
$config['db']['postgres']['port'] 		= (($config['env'] == 'development') ? '5432' : (($config['env'] == 'test') ? '5432' : '5432'));
$config['db']['postgres']['user'] 		= (($config['env'] == 'development') ? 'postgres' : (($config['env'] == 'test') ? 'postgres' : 'postgres'));
